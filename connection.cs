...
namespace GST
{
    ...
    {
        public static string strConnection = @"server=DESKTOP-HNC6N8N;database=GST;uid=sa;pwd=rockpari;Connect Timeout=200;pooling='true';Max Pool Size=500;Min Pool Size=5;";
